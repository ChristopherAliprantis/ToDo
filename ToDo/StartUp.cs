        ...
        this.Loaded +=async(s,e)=>
        {
            ...
            if (blocked)
            {
                ContentDialog dialog = new ContentDialog
                {
                    ...
                    Content = "Notifications are disabled for this computer. Please enable them in settings.\r\nOr else ToDos with a set time won't work.",
                    CloseButtonText = "OK",
            ...
            if (disabled)
            {
                ContentDialog dialog = new ContentDialog
                {
                    ...
                    Content = "Notifications are disabled for ToDo. Please enable them in settings.\r\nOr else ToDos with a set time won't work.",
                    CloseButtonText = "OK",
                    XamlRoot = this.XamlRoot
                };
                await dialog.ShowAsync();
